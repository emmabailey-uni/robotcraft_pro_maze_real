...
private:
    ...
    ros::Publisherpath_follow_vel_pub;
...
public:
    PathFollowingController(){
        ...
        this->path_follow_vel_pub = this->n.advertise<geometry_msgs::Twist>("path_following_vel", 10);

        // name_of_the_subscriber = n.subscribe("topic_name")
        this->amcl_sub = n.subscribe("amcl", 10, &PathFollowingController::amclCallback, this);
